      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={page === 1}
            className="flex items-center gap-1.5 px-3.5 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer shadow-xs"
          >
            ← Previous
          </button>
