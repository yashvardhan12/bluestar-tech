        ...
        <div className="flex items-center gap-2 pt-1">
          <div className="relative">
            ...
            <input
              ...
              className="pl-[38px] pr-3.5 py-2.5 w-80 border border-gray-300 rounded-lg shadow-xs text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-violet-400 focus:ring-4 focus:ring-violet-100 transition-shadow"
            />
          </div>
          {selected.size > 0 ? (
